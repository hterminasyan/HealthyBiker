sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/sap/healtybiker/HealtyBiker/app", ".html");
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#HealtyBiker-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#HealtyBiker-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("com.sap.healtybiker.HealtyBiker.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/sap/healtybiker/HealtyBiker/localService/mockserver"], function (mockserver) {
